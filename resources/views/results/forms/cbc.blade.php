<form action="{{ route('validate-results') }}" method="POST">
    @csrf
    <input type="hidden" name="test_code" value="HEMA-T01">
    
    <div>
        <h3 class="text-lg font-semibold text-center mb-4">COMPLETE BLOOD COUNT</h3>
        <table class="w-full border-collapse">
            ...
            <tbody>
                @foreach(['RBC' => '10^12/L', 'Hemoglobin' => 'g/L', 'Hematocrit' => 'L/L', 'WBC' => '10^9/L', 'Platelet Count' => '10^9/L', 'Neutrophil' => '%', 'Lymphocyte' => '%', 'Monocyte' => '%', 'Stabs' => '%', 'Eosinophil' => '%', 'Basophil' => '%', 'MCV' => 'fL', 'MCH' => 'pg', 'MCHC' => 'g/L'] as $parameter => $unit)
                <tr class="border-b">
