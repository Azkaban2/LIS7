<form action="{{ route('validate-results') }}" method="POST">
    @csrf
    <input type="hidden" name="test_code" value="CM-T01">
    <div>
        <h3 class="text-lg font-semibold text-center mb-4">FECALYSIS</h3>
        <table class="w-full border-collapse">
            ...
            <tbody>
                @foreach(['Color' => '', 'Consistency' => '', 'WBC' => '/HPF', 'RBC' => '/HPF', 'Bacteria' => '', 'Yeast Cell' => '', 'Fat Globules' => '', 'Occult Blood Test' => ''] as $parameter => $unit)
                <tr class="border-b">
