...
<div class="flex">
   ...
   <!-- Dengue Test Validation Content -->
   <div class="ml-64 flex-1 p-6 container mx-auto mt-10">
    <div class="bg-white shadow-md rounded p-6">
        <h3 class="text-lg font-semibold text-center mb-4">Validation - Dengue Test</h3>
        ...
        <!-- Form for Dengue Test Validation -->
