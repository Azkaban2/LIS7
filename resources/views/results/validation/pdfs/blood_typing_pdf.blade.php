    ...
    <head>
        ...
        <title>Blood Typing - PDF</title>
        <style>
            body {
                font-family: Arial, sans-serif;
                font-size: 10px; /* Adjusted for compactness */
                margin: 0;
                padding: 0;
            }
    ...
    <body>
        ...
        <div class="header">
            ...
            <h2 style="text-transform: uppercase; margin-top: 5px;">Blood Typing</h2>
        </div>
        ...
        <!-- Blood Typing Table Section -->
        <h3 style="text-align: center;">Blood Typing Results</h3>
