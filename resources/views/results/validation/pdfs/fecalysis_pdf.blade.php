...
<body>
    ...
    <div class="header">
        ...
        <h2 style="text-transform: uppercase; margin-top: 5px;">Fecalysis</h2>
    </div>
    ...
    <!-- Fecalysis Table Section -->
    <h3 style="text-align: center;">Fecalysis Results</h3>
