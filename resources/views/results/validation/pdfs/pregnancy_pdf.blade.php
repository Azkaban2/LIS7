...
<head>
    ...
    <title>Pregnancy Test - PDF</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <h2 style="text-transform: uppercase; margin-top: 5px;">Pregnancy Test</h2>
    </div>
    ...
    <!-- Pregnancy Test Table Section -->
    <h3 style="text-align: center;">Pregnancy Test Results</h3>
