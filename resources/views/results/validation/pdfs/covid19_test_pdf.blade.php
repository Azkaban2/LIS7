...
<head>
    ...
    <title>COVID-19 Rapid Antigen Test Report</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <p>229-6558 | 0917-125-7121 | eph.tibanga2020@gmail.com</p>
        <h2 style="margin-top: 5px;">COVID-19 Rapid Antigen Test</h2>
    </div>
    ...
    <h3 style="text-align: center;">COVID-19 Test Results</h3>
