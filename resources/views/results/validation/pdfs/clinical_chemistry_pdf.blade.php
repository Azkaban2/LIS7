...
<head>
    ...
    <title>Clinical Chemistry - PDF</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <h2 style="text-transform: uppercase; margin-top: 5px;">Clinical Chemistry</h2>
    </div>
    ...
    <!-- Clinical Chemistry Table Section -->
    <h3 style="text-align: center;">Clinical Chemistry Results</h3>
