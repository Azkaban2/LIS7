...
<head>
    ...
    <title>CBC with CT/BT Validation - PDF</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <h2 style="text-transform: uppercase; margin-top: 10px;">Hematology - CBC with CT/BT</h2>
    </div>
    ...
    <!-- CBC with CT/BT Table Section -->
    <h3 style="text-align: center;">Complete Blood Count with Clotting Time/Bleeding Time</h3>
