...
<body>
    ...
    <div class="header">
        ...
        <h2 style="text-transform: uppercase; margin-top: 5px;">Urinalysis</h2>
    </div>
    ...
    <!-- Urinalysis Table Section -->
    <h3 style="text-align: center;">Urinalysis Results</h3>
