...
<head>
    ...
    <title>ECG Validation - PDF</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <h2 style="text-transform: uppercase; margin-top: 10px;">Electrocardiogram (ECG)</h2>
    </div>
    ...
    <!-- ECG Table Section -->
    <h3 style="text-align: center;">ECG Test Results</h3>
