...
<div class="flex">
    ...
    <!-- Urinalysis Validation Content -->
    <div class="ml-64 flex-1 p-6 container mx-auto mt-10">
        <div class="bg-white shadow-md rounded p-6">
            <h3 class="text-lg font-semibold text-center mb-4">Validation - Urinalysis</h3>
        ...
        <div class="mb-4 bg-gray-100 p-6 rounded shadow-md">
            ...
            <!-- Form for Urinalysis Validation -->
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        resultInputs.forEach(input => {
            input.addEventListener('input', function () {
                ...
                // Expected value mappings (for non-numerical values)
                const expectedValues = {
                    "Color": ["Yellow", "Straw", "Amber"],
                    "Transparency": ["Clear", "Slightly Cloudy"],
                    "Glucose": ["Negative"],
                    "Protein": ["Negative"]
                };
                ...
                // Check if the parameter requires expected values validation
                if (expectedValues.hasOwnProperty(parameter)) {
                    isValid = expectedValues[parameter].includes(inputValue);
                } 
                // Check if it's a numerical range validation
