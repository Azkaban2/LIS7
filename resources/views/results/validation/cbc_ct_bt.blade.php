...
<div class="flex">
 ...
 <!-- CBC with CT/BT Validation Content -->
<div class="ml-64 flex-1 p-6 container mx-auto mt-10">
    <div class="bg-white shadow-md rounded p-6">
        <h3 class="text-lg font-semibold text-center mb-4">Validation - CBC with CT/BT</h3>
        ...
        <!-- Validation Table & PDF Generation Form -->
            ...
            <table class="w-full border-collapse">
                ...
                <tbody>
                    @foreach($validatedResults as $index => $result)
                        ...
                        {{-- OTHERS HEADER (Before Clotting Time and Bleeding Time) --}}
                        @if($result['parameter'] === 'Clotting Time')
                            <tr class="border-b bg-gray-200">
                                <td colspan="5" class="py-2 text-left font-semibold text-gray-700 px-4">
                                    OTHERS
                                </td>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="py-2 text-center">
                                {{-- Display Reference Range Correctly for Gender-Specific Parameters --}}
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    resultInputs.forEach(input => {
        input.addEventListener("input", function () {
            ...
            // Update flag UI without modifying form data
            if (flagSpan) {
